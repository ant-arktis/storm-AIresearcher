...
class STORMWikiLMConfigs(LMConfigs):
    ...
    def init_openai_model(
        ...
        if openai_type and openai_type == 'azure':
            ...
            self.outline_gen_lm = OpenAIModel(model='gpt-4o-2024-05-13',#'gpt-4-0125-preview',
                                              max_tokens=400, **openai_kwargs)
            self.article_gen_lm = OpenAIModel(model='gpt-4o-2024-05-13',#'gpt-4-0125-preview',
                                              max_tokens=700, **openai_kwargs)
            self.article_polish_lm = OpenAIModel(model='gpt-4o-2024-05-13',#'gpt-4-0125-preview',
                                                 max_tokens=4000, **openai_kwargs)
        else:
